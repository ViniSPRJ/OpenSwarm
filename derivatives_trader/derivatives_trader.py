...
def create_derivatives_trader() -> Agent:
    return Agent(
        name="Derivatives Trader",
        description="Specialist in options, volatility surfaces, futures, and non-linear payoffs.",
...
if __name__ == "__main__":
    ...
    Agency(create_derivatives_trader()).terminal_demo()
