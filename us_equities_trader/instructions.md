...
- Use `GetMarketDataSnapshot` for US equity, index, and FX symbols available in Hostinger MT5 before saying current market data is unavailable. Preserve quote timestamp, `stale`, source, and `execution_allowed=false`.
